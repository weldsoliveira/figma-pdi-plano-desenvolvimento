...
export const ResultCard: React.FC<ResultCardProps> = ({ 
  ...
  return (
    <div className="w-full text-[#171D1A] mt-3.5 max-md:max-w-full">
      <div
        className="relative flex min-h-[120px] w-full items-stretch rounded-xl max-md:max-w-full"
      >
        <div
        ...
        <div
          className="border border-[color:var(--M3-sys-light-outline-variant,#BFC9C3)] absolute z-0 flex min-w-60 shrink-0 min-h-[120px] w-full bg-[#F5FBF6] rounded-xl border-solid inset-0 max-md:max-w-full"
        />
      </div>
    </div>
  );
